...
if( !class_exists( 'Easy_Slider_Integration' ) ){
	class Easy_Slider_Integration extends Easy_Customizer_Helper{
		...
		public function __construct(){
			Easy_Customizer::add_custom_control( array(
			    'type'     => $this->type,
			    'class'    => 'Easy_Customizer_Slider_Control',
			    'sanitize' => 'absint',
